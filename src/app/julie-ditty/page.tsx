      ...
      <div className="mx-auto max-w-5xl px-6 py-12 sm:px-8 lg:py-14">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-start lg:gap-12">
          <div className="max-w-prose space-y-5 text-base leading-relaxed text-neutral-800">
            <p>
              Julie Ditty grew up in Ashland, Kentucky, and became one of the
              most accomplished American women&apos;s players of her generation.
              A standout junior and collegiate athlete, she spent a year training
              in Lexington alongside Ryan Holder when they were 15 before going
              on to compete on the WTA Tour, achieving a career-high singles
              ranking inside the world&apos;s top 100 and representing the
